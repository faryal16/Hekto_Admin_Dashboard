...
import { getMyOrders } from "@/sanity/lib/quires";


// Change OrdersPage to a Server Component
const OrdersPage = async () => {
//   const { userId } = await auth(); // This works server-side only

//   if (!userId) {
//     return redirect("/"); // Redirect if no userId
//   }
